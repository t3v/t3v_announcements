# Table structure for table `tx_t3vannouncements_domain_model_job_ad`
DROP TABLE IF EXISTS tx_t3vannouncements_domain_model_job_ad;
CREATE TABLE tx_t3vannouncements_domain_model_job_ad (
...
DROP TABLE IF EXISTS tx_t3vannouncements_domain_model_news_article;
