<?php
namespace T3v\T3vAnnouncements\Tests\Functional;
 ...
 *
 * @package T3v\T3vAnnouncements\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
   ...
   * @var array
   */
  protected $testExtensionsToLoad = ['typo3conf/ext/t3v_announcements'];
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Announcements</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_announcements/Tests/Functional/Fixtures/Frontend/Basic.ts']);
  }
